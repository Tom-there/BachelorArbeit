...
\subsubsection{Drei Address Code} \label{t:tac}
...
Lebendig bedeutet in diesem Kontext, das dieser Wert definiert wurde
...
Arbeit implementierten Konzepte, wenden wir uns nun der Implementierung zu.
